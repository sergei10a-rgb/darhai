...
Засвар бүрийг мутацийн шалгалтаар нотолсон (`ac4aa1866`-д 7 мутаци: close/error
сонсогч, pid-reuse хамгаалалт ×2, `allSettled`→`all`, WCore нүцгэн SIGTERM,
OpenClaw нүцгэн SIGTERM, exit-handler-ийн холболт — тус бүр 1–4 тест унагаав).
`tsc` 0, тестийн `tsc` 0, lint 0 алдаа, иж бүрдэл **11,148 тэнцсэн / 0 унасан**.
