...
const SiderDocumentsEntry: React.FC<SiderDocumentsEntryProps> = ({
  ...
  const label = t('documents.sidebarLabel');
    ...
    return (
      <Tooltip {...siderTooltipProps} content={label} position='right'>
        <div
          ...
          onClick={onClick}
          data-testid='sider-documents-entry'
        >
          <FileText size={20} className='block leading-none shrink-0' style={{ lineHeight: 0 }} />
        </div>
      </Tooltip>
    );
  }
    ...
    <Tooltip {...siderTooltipProps} content={label} position='right'>
      ...
      >
        <span className='w-28px h-28px flex items-center justify-center shrink-0'>
          <FileText size={20} className='block leading-none' style={{ lineHeight: 0 }} />
        </span>
