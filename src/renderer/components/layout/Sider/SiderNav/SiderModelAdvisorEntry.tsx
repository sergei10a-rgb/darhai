...
interface SiderModelAdvisorEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderModelAdvisorEntry: React.FC<SiderModelAdvisorEntryProps> = ({
  isActive,
  collapsed,
  siderTooltipProps,
  onClick,
  ...
  const label = t('modelAdvisor.sidebarLabel');
    ...
    return (
      <Tooltip {...siderTooltipProps} content={label} position='right'>
        <div
          ...
          onClick={onClick}
          data-testid='sider-model-advisor-entry'
        >
          <Cpu size={20} className='block leading-none shrink-0' style={{ lineHeight: 0 }} />
        </div>
      </Tooltip>
    );
  }
    ...
    <Tooltip {...siderTooltipProps} content={label} position='right'>
      ...
      >
        <span className='w-28px h-28px flex items-center justify-center shrink-0'>
          <Cpu size={20} className='block leading-none' style={{ lineHeight: 0 }} />
        </span>
...
export default SiderModelAdvisorEntry;
