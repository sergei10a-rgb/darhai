 ...
 *
 * Only web/mail and the app's own deep-link scheme (`darhai:`, see
 * src/process/utils/deepLink.ts PROTOCOL_SCHEMES) are permitted.
 * Everything else
 ...
 */
export const ALLOWED_EXTERNAL_URL_SCHEMES: readonly string[] = ['https:', 'http:', 'mailto:', 'darhai:'];
