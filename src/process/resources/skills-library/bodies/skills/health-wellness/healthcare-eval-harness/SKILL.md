...
description: >-
  Patient safety evaluation harness for healthcare application deployments. Automated test suites
  for CDSS accuracy, PHI exposure, clinical workflow integrity, and integration compliance. Blocks
  deployments on safety failures.
metadata:
  origin: Health1 Super Speciality Hospitals — contributed by Dr. Keyur Patel
  author: darhai
  version: 1.0.0
  category: health-wellness
  tags: healthcare patient-safety eval-harness cdss compliance
version: 1.0.0
category: health-wellness
---
