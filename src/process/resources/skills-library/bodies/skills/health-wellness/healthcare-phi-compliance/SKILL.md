...
description: >-
  Protected Health Information (PHI) and Personally Identifiable Information (PII) compliance
  patterns for healthcare applications. Covers data classification, access control, audit trails,
  encryption, and common leak vectors.
metadata:
  origin: Health1 Super Speciality Hospitals — contributed by Dr. Keyur Patel
  author: darhai
  version: 1.0.0
  category: health-wellness
  tags: healthcare phi pii compliance data-privacy
version: 1.0.0
category: health-wellness
---
