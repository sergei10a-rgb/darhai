...
name: ui-demo
description: >-
  Record polished UI demo videos using Playwright. Use when the user asks to create a demo,
  walkthrough, screen recording, or tutorial video of a web application. Produces WebM videos with
  visible cursor, natural pacing, and professional feel.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: creative-arts
  tags: playwright demo-video screen-recording walkthrough webm
category: creative-arts
---
