...
description: >-
  Use this skill when inspecting Blender characters, rigs, poses, animation retargeting, ground
  contact, facing direction, or model-vs-motion alignment where screenshots alone are not enough.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: creative-arts
  tags: blender 3d animation rigging motion-inspection
