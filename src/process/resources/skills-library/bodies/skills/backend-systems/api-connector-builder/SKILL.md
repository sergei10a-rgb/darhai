...
description: >-
  Build a new API connector or provider by matching the target repo's existing integration pattern
  exactly. Use when adding one more integration without inventing a second architecture.
metadata:
  origin: ECC direct-port adaptation
  author: darhai
  version: 1.0.0
  category: backend-systems
  tags: api-integration connector integration-pattern backend provider
version: 1.0.0
category: backend-systems
---
