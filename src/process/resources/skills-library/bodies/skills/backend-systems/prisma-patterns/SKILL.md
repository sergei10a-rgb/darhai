...
description: >-
  Prisma ORM patterns for TypeScript backends — schema design, query optimization, transactions,
  pagination, and critical traps like updateMany returning count not records, $transaction timeouts,
  migrate dev resetting the DB, @updatedAt skipped on bulk writes, and serverless connection
  exhaustion.
metadata:
  origin: ECC
  author: darhai
  ...
  tags: prisma orm typescript database transactions
category: backend-systems
---
