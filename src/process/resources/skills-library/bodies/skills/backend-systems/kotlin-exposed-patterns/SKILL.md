...
description: >-
  JetBrains Exposed ORM patterns including DSL queries, DAO pattern, transactions, HikariCP
  connection pooling, Flyway migrations, and repository pattern.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: backend-systems
  tags: kotlin exposed orm database hikaricp
category: backend-systems
---
