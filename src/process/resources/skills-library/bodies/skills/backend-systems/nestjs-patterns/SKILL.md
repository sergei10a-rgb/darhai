...
description: >-
  NestJS architecture patterns for modules, controllers, providers, DTO validation, guards,
  interceptors, config, and production-grade TypeScript backends.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: backend-systems
  tags: nestjs typescript backend dependency-injection rest-api
category: backend-systems
---
