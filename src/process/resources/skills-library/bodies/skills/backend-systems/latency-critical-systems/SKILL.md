...
description: >-
  Use for latency-sensitive systems such as realtime dashboards, market data, streaming agents,
  execution gateways, queues, caches, or HFT-like infrastructure where freshness and p95 latency
  matter.
metadata:
  origin: ECC
  author: darhai
  ...
  tags: latency performance realtime low-latency p95
