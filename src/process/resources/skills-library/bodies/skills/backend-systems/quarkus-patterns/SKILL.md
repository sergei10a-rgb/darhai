...
description: >-
  Quarkus 3.x LTS architecture patterns with Camel for messaging, RESTful API design, CDI services,
  data access with Panache, and async processing. Use for Java Quarkus backend work with
...
metadata:
  ...
  tags: quarkus java backend rest-api event-driven
category: backend-systems
---
