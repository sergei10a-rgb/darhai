...
name: dart-security
description: >-
  dart security conventions and rules. Use when writing or reviewing dart code for security. - Never
  hardcode API keys, tokens, or credentials in Dart source
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: dart security standards best-practices
  category: security
