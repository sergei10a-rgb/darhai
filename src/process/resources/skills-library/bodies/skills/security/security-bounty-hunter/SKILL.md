...
description: >-
  Hunt for exploitable, bounty-worthy security issues in repositories. Focuses on remotely reachable
  vulnerabilities that qualify for real reports instead of noisy local-only findings.
metadata:
  origin: ECC direct-port adaptation
  author: darhai
  version: 1.0.0
  category: security
  tags: bug-bounty vulnerability exploit security-audit pentest
version: 1.0.0
category: security
---
