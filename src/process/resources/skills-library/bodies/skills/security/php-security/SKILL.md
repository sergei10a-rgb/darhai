...
name: php-security
description: >-
  php security conventions and rules. Use when writing or reviewing php code for security. -
  Validate request input at the framework boundary (`FormRequest`, Symfony Validator, or explicit
  DTO validation).
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: php security standards best-practices
  category: security
