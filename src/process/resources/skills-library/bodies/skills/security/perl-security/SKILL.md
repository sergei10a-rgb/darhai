...
name: perl-security
description: >-
  Comprehensive Perl security covering taint mode, input validation, safe process execution, DBI
  parameterized queries, web security (XSS/SQLi/CSRF), and perlcritic security policies.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: security
  tags: perl input-validation sql-injection xss taint-mode
category: security
---
