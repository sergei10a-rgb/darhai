...
name: java-security
description: >-
  java security conventions and rules. Use when writing or reviewing java code for security. - Never
  hardcode API keys, tokens, or credentials in source code
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: java security standards best-practices
  category: security
