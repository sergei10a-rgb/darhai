...
name: arkts-security
description: >-
  arkts security conventions and rules. Use when writing or reviewing arkts code for security. All
  system API calls requiring permissions must be declared:
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: arkts security standards best-practices
  category: security
