...
name: web-security
description: >-
  web security conventions and rules. Use when writing or reviewing web code for security. Always
  configure a production CSP.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: web security standards best-practices
  category: security
