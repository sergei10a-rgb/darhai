...
description: >-
  Review prediction-market, basket, oracle, and trading-agent workflows for compliance, safety,
  data-quality, privacy, and execution risk. Use before any workflow handles venue auth, user
  portfolio data, API keys, or trade planning.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: security
  tags: risk-review compliance trading-agent prediction-markets data-quality
category: security
---
