...
description: >-
  Security patterns for autonomous trading agents with wallet or transaction authority. Covers
  prompt injection, spend limits, pre-send simulation, circuit breakers, MEV protection, and key
  handling.
metadata:
  ...
  version: 1.0.0
  category: security
  tags: trading-agents wallet-security prompt-injection circuit-breakers mev
version: 1.0.0
category: security
---
