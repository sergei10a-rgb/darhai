...
name: vue-security
description: >-
  vue security conventions and rules. Use when writing or reviewing vue code for security. - Text
  interpolation `{{ }}` and dynamic attribute bindings (`:title`) are auto-escaped. The vectors
  below are NOT protected.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: vue security standards best-practices
  category: security
