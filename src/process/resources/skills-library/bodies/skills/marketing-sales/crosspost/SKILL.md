...
name: crosspost
description: >-
  Multi-platform content distribution across X, LinkedIn, Threads, and Bluesky. Adapts content per
  platform using content-engine patterns. Never posts identical content cross-platform. Use when the
  user wants to distribute content across social platforms.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: marketing-sales
  tags: social-media cross-posting content-distribution multi-platform social-publishing
category: marketing-sales
---
