...
description: >-
  Use when a brand needs to discover or articulate its identity through structured multi-session
  interviews. Covers purpose, positioning, audience, personality, voice, narrative, and
  founder-brand tension across 8 modules using laddering, 5 Whys, and projective techniques.
  Produces a resumable session with disk-persisted state and a master brandbook (90_SYNTHESIS.md).
metadata:
  author: darhai
  version: 1.0.0
  category: marketing-sales
  tags: brand-identity brand-discovery positioning brand-voice interview
category: marketing-sales
---
