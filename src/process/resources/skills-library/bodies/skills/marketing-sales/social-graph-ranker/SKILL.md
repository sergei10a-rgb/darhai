...
description: >-
  Weighted social-graph ranking for warm intro discovery, bridge scoring, and network gap analysis
  across X and LinkedIn. Use when the user wants the reusable graph-ranking engine itself, not the
  broader outreach or network-maintenance workflow layered on top of it.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: marketing-sales
  tags: social-graph warm-intro network-analysis bridge-scoring ranking
category: marketing-sales
---
