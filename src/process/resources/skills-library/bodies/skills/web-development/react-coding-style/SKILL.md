...
description: >-
  react coding style conventions and rules. Use when writing or reviewing react code for coding
  style. - `.tsx` for any file containing JSX, even one-liner snippets
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: react coding-style standards best-practices
