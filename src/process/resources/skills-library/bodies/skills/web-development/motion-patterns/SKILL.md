...
description: >-
  Production-ready animation patterns for React / Next.js — button, modal, toast, stagger, page
  transitions, exit animations, scroll, and layout — built on motion-foundations tokens and springs.
version: 1
tags:
  - motion
  - animation
...
metadata:
  ...
  version: 1.0.0
  category: web-development
  tags: react-animation ui-motion transitions stagger modal-toast
---
