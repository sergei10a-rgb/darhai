...
name: react-hooks
description: >-
  react hooks conventions and rules. Use when writing or reviewing react code for hooks. Enforce
  `eslint-plugin-react-hooks` with `react-hooks/rules-of-hooks` set to error.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: react hooks standards best-practices
