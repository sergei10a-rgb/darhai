...
description: >-
  angular patterns conventions and rules. Use when writing or reviewing angular code for patterns.
  Smart (container) components own data fetching and state. Dumb (presentational) components receive
  inputs and emit outputs only — no service injection.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: angular patterns standards best-practices
