...
description: >-
  angular coding style conventions and rules. Use when writing or reviewing angular code for coding
  style. Always check the project's Angular version before writing code — features differ
  significantly between versions. Run `ng version` or inspect `package.json`. When creating a new
  pro
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: angular coding-style standards best-practices
