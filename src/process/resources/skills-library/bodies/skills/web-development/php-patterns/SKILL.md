...
name: php-patterns
description: >-
  php patterns conventions and rules. Use when writing or reviewing php code for patterns. - Keep
  controllers focused on transport: auth, validation, serialization, status codes.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: php patterns standards best-practices
