...
name: vite-patterns
description: >-
  Vite build tool patterns including config, plugins, HMR, env variables, proxy setup, SSR, library
  mode, dependency pre-bundling, and build optimization. Activate when working with vite.config.ts,
  Vite plugins, or Vite-based projects.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: web-development
  tags: vite build-tool hmr bundling config
category: web-development
---
