...
name: react-patterns
description: >-
  react patterns conventions and rules. Use when writing or reviewing react code for patterns.
  Container components own data fetching, state, and side effects. Presentational components receive
  props and render — no service calls, no hooks beyond local UI state.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: react patterns standards best-practices
