...
name: vue-patterns
description: >-
  vue patterns conventions and rules. Use when writing or reviewing vue code for patterns. - The
  composable (`useXxx`) is the reusable-logic unit. In Feature-Sliced Design it lives in the slice
  `model` segment.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: vue patterns standards best-practices
