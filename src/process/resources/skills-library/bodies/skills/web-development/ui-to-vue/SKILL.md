...
name: ui-to-vue
description: >-
  Use when the user has UI screenshots or design exports that need batch conversion into Vue 3
  components, especially with Vant, Element Plus, or Ant Design Vue.
metadata:
  origin: community
  author: darhai
  version: 1.0.0
  category: web-development
  tags: vue ui-conversion components design-to-code frontend
category: web-development
---
