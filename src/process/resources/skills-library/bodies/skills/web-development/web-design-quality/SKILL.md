...
description: >-
  web design quality conventions and rules. Use when writing or reviewing web code for design
  quality. Do not ship generic template-looking UI. Frontend output should look intentional,
  opinionated, and specific to the product.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: web design-quality standards best-practices
