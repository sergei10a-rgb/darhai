...
description: >-
  Advanced motion patterns for React / Next.js — drag & drop, gestures, text animations, SVG path
  drawing, custom hooks, imperative sequences (useAnimate), loaders, and the full API decision tree.
  Requires motion-foundations.
version: 1
tags:
  - motion
  - animation
...
metadata:
  ...
  version: 1.0.0
  category: web-development
  tags: react-animation motion gestures drag-drop svg-animation
---
