...
name: web-patterns
description: >-
  web patterns conventions and rules. Use when writing or reviewing web code for patterns. Use
  compound components when related UI shares state and interaction semantics:
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: web patterns standards best-practices
