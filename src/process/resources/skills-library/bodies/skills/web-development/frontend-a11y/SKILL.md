...
name: frontend-a11y
description: >
  Accessibility patterns for React and Next.js — semantic HTML, ARIA attributes, form labeling,
  keyboard navigation, focus management, and screen reader support. Use when building any
  interactive UI component or form.
metadata:
  origin: community
  author: darhai
  version: 1.0.0
  category: web-development
  tags: accessibility a11y frontend wcag aria
category: web-development
---
