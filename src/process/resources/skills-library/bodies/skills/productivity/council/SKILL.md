...
name: council
description: >-
  Convene a four-voice council for ambiguous decisions, tradeoffs, and go/no-go calls. Use when
  multiple valid paths exist and you need structured disagreement before choosing.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: productivity
  tags: decision-making tradeoffs deliberation go-no-go structured-thinking
category: productivity
---
