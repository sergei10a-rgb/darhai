...
description: >-
  ...
  decks, and shared documents. Use when the user needs to find, summarize, edit, migrate, or clean
  up Google Workspace assets without dropping to raw tool calls.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: productivity
  tags: google-workspace drive docs sheets collaboration
category: productivity
---
