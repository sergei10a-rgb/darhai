...
description: >-
  Prevent Ethereum hashing bugs in JavaScript and TypeScript. Node's sha3-256 is NIST SHA3, not
  Ethereum Keccak-256, and silently breaks selectors, signatures, storage slots, and address
  derivation.
metadata:
  ...
  tags: ethereum keccak256 hashing web3 javascript
version: 1.0.0
category: emerging-tech
---
