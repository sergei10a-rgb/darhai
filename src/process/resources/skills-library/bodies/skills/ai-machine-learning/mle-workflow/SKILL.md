...
description: >-
  ...
  evaluation, deployment, monitoring, and rollback. Use when building, reviewing, or hardening ML
  systems beyond one-off notebooks.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: ai-machine-learning
  tags: mlops model-deployment training-pipeline model-monitoring ml-engineering
category: ai-machine-learning
---
