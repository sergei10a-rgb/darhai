...
description: >-
  Design background Data Atlas style agents for Itô basket research, market discovery, parameter
  drafting, and human-in-the-loop editing. Use for architecture and workflow planning, not live
  order execution.
metadata:
  origin: ECC
  author: darhai
  ...
  tags: prediction-markets agent-design market-discovery workflow ito
category: ai-machine-learning
---
