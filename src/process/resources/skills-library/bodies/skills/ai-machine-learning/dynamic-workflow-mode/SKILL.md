...
description: >-
  Design task-local harnesses, eval gates, and reusable skill extraction for Claude dynamic workflow
  mode and other adaptive agent harnesses.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: ai-machine-learning
  tags: agent-harness workflow eval-gates skill-extraction adaptive
category: ai-machine-learning
---
