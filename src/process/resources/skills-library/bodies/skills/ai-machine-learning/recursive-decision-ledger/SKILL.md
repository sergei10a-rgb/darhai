...
description: >-
  Use when the user asks for repeated rollouts, marked decision processes, high-dimensional search,
  stochastic optimization, local-optima exploration, ensemble comparison, or recursive reasoning
...
metadata:
  ...
  tags: stochastic-optimization recursive-reasoning ensemble-search decision-ledger rollouts
