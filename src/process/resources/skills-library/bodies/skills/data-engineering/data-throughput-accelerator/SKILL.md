...
description: >-
  Use when large data ingestion, backfill, export, ETL, warehouse loading, manifest catch-up, or
  table synchronization needs to become much faster while preserving data correctness.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: data-engineering
  tags: etl data-ingestion throughput backfill performance
