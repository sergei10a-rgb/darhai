...
description: >-
  ...
  prices, news, GitHub, sports, anything. Scrapes on a schedule, enriches data with a free LLM
  (Gemini Flash), stores results in Notion/Sheets/Supabase, and learns from user feedback. Runs 100%
  free on GitHub Actions. Use when the user wants to monitor, collect, or track any public data
  automatically.
metadata:
  origin: community
  author: darhai
  ...
  tags: web-scraping data-collection automation scheduling llm-enrichment
category: data-engineering
---
