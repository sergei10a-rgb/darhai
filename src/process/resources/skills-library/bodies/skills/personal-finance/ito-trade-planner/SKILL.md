...
description: >-
  Build a non-advisory prediction-market trade planning worksheet for Itô or venue workflows. Use to
  inspect venues, underliers, constraints, order prerequisites, and manual execution steps without
  placing trades or recommending positions.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: personal-finance
  tags: prediction-markets trade-planning venues non-advisory ito
category: personal-finance
---
