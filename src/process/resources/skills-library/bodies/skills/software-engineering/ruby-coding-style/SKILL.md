...
description: >-
  ruby coding style conventions and rules. Use when writing or reviewing ruby code for coding style.
  - Target **Ruby 3.3+** for new Rails work unless the project already pins an older supported
  runtime.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: ruby coding-style standards best-practices
