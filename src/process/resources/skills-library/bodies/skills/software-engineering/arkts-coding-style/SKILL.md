...
description: >-
  arkts coding style conventions and rules. Use when writing or reviewing arkts code for coding
  style. ArkTS is a strict, statically-typed subset of TypeScript. Violating these constraints
  causes **compilation failures**.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: arkts coding-style standards best-practices
