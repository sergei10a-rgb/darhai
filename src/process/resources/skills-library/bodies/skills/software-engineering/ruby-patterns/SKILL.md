...
name: ruby-patterns
description: >-
  ruby patterns conventions and rules. Use when writing or reviewing ruby code for patterns. - Start
  with plain Rails MVC and Active Record conventions for small and medium features.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: ruby patterns standards best-practices
