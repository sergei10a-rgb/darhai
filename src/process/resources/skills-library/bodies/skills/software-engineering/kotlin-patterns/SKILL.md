...
description: >-
  Idiomatic Kotlin patterns, best practices, and conventions for building robust, efficient, and
  maintainable Kotlin applications with coroutines, null safety, and DSL builders.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: software-engineering
  tags: kotlin idioms coroutines null-safety best-practices
category: software-engineering
---
