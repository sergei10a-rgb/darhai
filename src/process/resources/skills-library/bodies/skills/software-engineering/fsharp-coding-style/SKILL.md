...
description: >-
  fsharp coding style conventions and rules. Use when writing or reviewing fsharp code for coding
  style. - Follow standard F# conventions and leverage the type system for correctness
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: fsharp coding-style standards best-practices
