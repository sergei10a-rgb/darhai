...
description: >-
  kotlin coding style conventions and rules. Use when writing or reviewing kotlin code for coding
  style. - **ktlint** or **Detekt** for style enforcement
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: kotlin coding-style standards best-practices
