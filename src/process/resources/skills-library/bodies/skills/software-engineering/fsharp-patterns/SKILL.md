...
description: >-
  fsharp patterns conventions and rules. Use when writing or reviewing fsharp code for patterns. Use
  `Result<'T, 'TError>` with railway-oriented programming instead of exceptions for expected
  failures.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: fsharp patterns standards best-practices
