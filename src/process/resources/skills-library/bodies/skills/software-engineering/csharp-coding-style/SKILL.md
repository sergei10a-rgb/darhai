...
description: >-
  csharp coding style conventions and rules. Use when writing or reviewing csharp code for coding
  style. - Follow current .NET conventions and enable nullable reference types
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: csharp coding-style standards best-practices
