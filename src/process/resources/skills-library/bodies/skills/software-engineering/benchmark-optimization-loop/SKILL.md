...
description: >-
  Use when the user asks to make something faster, try many variants, run recursive optimization,
  benchmark latency/throughput/cost, or choose the best implementation by repeated measured tests.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: software-engineering
  tags: optimization performance benchmarking latency throughput
