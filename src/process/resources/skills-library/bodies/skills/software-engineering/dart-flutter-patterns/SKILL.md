...
description: >-
  Production-ready Dart and Flutter patterns covering null safety, immutable state, async
  composition, widget architecture, popular state management frameworks (BLoC, Riverpod, Provider),
  GoRouter navigation, Dio networking, Freezed code generation, and clean architecture.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: software-engineering
  tags: flutter dart mobile state-management clean-architecture
category: software-engineering
---
