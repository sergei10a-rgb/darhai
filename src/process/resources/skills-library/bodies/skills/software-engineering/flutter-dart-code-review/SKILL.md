...
description: >-
  Library-agnostic Flutter/Dart code review checklist covering widget best practices, state
  management patterns (BLoC, Riverpod, Provider, GetX, MobX, Signals), Dart idioms, performance,
...
metadata:
  ...
  tags: flutter dart code-review mobile state-management
category: software-engineering
---
