...
description: >-
  ...
  Covers OAuth auth patterns, rate limits, and platform-native content posting. Use when the user
  wants to interact with X programmatically.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: software-engineering
  tags: x-twitter api-integration oauth rate-limits posting
category: software-engineering
---
