...
name: code-tour
description: >-
  Create CodeTour `.tour` files — persona-targeted, step-by-step walkthroughs with real file and
  line anchors. Use for onboarding tours, architecture walkthroughs, PR tours, RCA tours, and
  structured "explain how this works" requests.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: software-engineering
  tags: code-tour onboarding walkthrough documentation codebase
category: software-engineering
---
