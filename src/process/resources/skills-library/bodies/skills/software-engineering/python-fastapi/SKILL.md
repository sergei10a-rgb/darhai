...
name: python-fastapi
description: >-
  python fastapi conventions and rules. Use when writing or reviewing python code for fastapi. Use
  these rules for FastAPI projects alongside the general Python rules.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: python fastapi standards best-practices
