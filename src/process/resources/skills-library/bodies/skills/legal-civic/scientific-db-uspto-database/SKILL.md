...
description: >-
  USPTO patent and trademark data workflow for official record lookup, PatentSearch queries, TSDR
  checks, assignment data, and reproducible IP research logs.
metadata:
  origin: community
  author: darhai
  version: 1.0.0
  category: legal-civic
  tags: uspto patents trademarks ip-research legal
category: legal-civic
---
