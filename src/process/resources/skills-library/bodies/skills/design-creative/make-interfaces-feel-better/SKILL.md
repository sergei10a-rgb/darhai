...
description: >-
  Apply concrete design-engineering details that make interfaces feel polished. Use when reviewing
  or improving UI spacing, typography, borders, shadows, motion, hit areas, icons, text wrapping,
...
metadata:
  ...
  tags: ui-polish ux micro-interactions typography spacing
category: design-creative
---
