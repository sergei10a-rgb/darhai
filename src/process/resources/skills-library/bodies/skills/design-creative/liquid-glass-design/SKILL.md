...
description: >-
  iOS 26 Liquid Glass design system — dynamic glass material with blur, reflection, and interactive
  morphing for SwiftUI, UIKit, and WidgetKit.
metadata:
  author: darhai
  version: 1.0.0
  category: design-creative
  tags: ios liquid-glass swiftui uikit ui-design
category: design-creative
---
