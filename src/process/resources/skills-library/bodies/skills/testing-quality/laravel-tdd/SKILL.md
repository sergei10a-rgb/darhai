...
name: laravel-tdd
description: >-
  Laravel testing strategies with PHPUnit, Pest, model factories, HTTP tests, Sanctum authentication
  testing, mocking, and coverage.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: testing-quality
  tags: laravel php tdd phpunit pest
category: testing-quality
---
