...
name: java-testing
description: >-
  java testing conventions and rules. Use when writing or reviewing java code for testing. - **JUnit
  5** (`@Test`, `@ParameterizedTest`, `@Nested`, `@DisplayName`)
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: java testing standards best-practices
