...
description: >-
  ...
  database dependencies, automated bug-check workflows, and patterns to catch AI blind spots where
  the same model writes and reviews code.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: testing-quality
  tags: regression-testing ai-assisted sandbox-testing bug-detection qa
category: testing-quality
---
