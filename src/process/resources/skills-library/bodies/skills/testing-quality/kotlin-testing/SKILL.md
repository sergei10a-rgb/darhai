...
name: kotlin-testing
description: >-
  Kotlin testing patterns with Kotest, MockK, coroutine testing, property-based testing, and Kover
  coverage. Follows TDD methodology with idiomatic Kotlin practices.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: testing-quality
  tags: kotlin testing kotest mockk tdd
category: testing-quality
---
