...
description: >-
  Verification loop for Laravel projects: env checks, linting, static analysis, tests with coverage,
  security scans, and deployment readiness.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: testing-quality
  tags: laravel verification linting coverage deployment-readiness
category: testing-quality
---
