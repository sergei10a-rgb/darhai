...
name: react-testing
description: >-
  react testing conventions and rules. Use when writing or reviewing react code for testing. -
  **React Testing Library (RTL)** — the standard for component testing. Tests behavior through the
  rendered DOM.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: react testing standards best-practices
