...
name: ruby-testing
description: >-
  ruby testing conventions and rules. Use when writing or reviewing ruby code for testing. - Use
  **Minitest** when the Rails app follows the default Rails test stack.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: ruby testing standards best-practices
