...
name: php-testing
description: >-
  php testing conventions and rules. Use when writing or reviewing php code for testing. Use
  **PHPUnit** as the default test framework. If **Pest** is configured in the project, prefer Pest
  for new tests and avoid mixing frameworks.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: php testing standards best-practices
