...
name: perl-testing
description: >-
  Perl testing patterns using Test2::V0, Test::More, prove runner, mocking, coverage with
  Devel::Cover, and TDD methodology.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: testing-quality
  tags: perl testing tdd code-coverage unit-testing
category: testing-quality
---
