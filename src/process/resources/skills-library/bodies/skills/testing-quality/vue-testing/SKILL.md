...
name: vue-testing
description: >-
  vue testing conventions and rules. Use when writing or reviewing vue code for testing. - Vitest
  (Vite-native runner) plus `@vue/test-utils`. `create-vue` scaffolds `@vitejs/plugin-vue`.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: vue testing standards best-practices
