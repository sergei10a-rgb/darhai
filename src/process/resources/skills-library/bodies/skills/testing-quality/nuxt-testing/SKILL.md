...
name: nuxt-testing
description: >-
  nuxt testing conventions and rules. Use when writing or reviewing nuxt code for testing. Package:
  `@nuxt/test-utils`. Vitest-first for unit and component tests, with built-in Playwright browser
  E2E support. nuxt-vitest and vitest-environment-nuxt are superseded and fol
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: nuxt testing standards best-practices
