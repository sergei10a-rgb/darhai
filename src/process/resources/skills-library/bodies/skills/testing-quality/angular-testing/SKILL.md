...
description: >-
  angular testing conventions and rules. Use when writing or reviewing angular code for testing. Use
  the test runner configured by the project. Check `angular.json` and `package.json`; Angular
  projects commonly use Vitest, Jest, or Jasmine + Karma.
license: Apache-2.0
metadata:
  author: darhai
  version: 1.0.0
  tags: angular testing standards best-practices
