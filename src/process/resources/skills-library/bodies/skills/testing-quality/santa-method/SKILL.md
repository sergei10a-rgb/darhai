...
name: santa-method
description: >-
  Multi-agent adversarial verification with convergence loop. Two independent review agents must
  both pass before output ships.
metadata:
  origin: Ronald Skelton - Founder, RapportScore.ai
  author: darhai
  version: 1.0.0
  category: testing-quality
  tags: multi-agent adversarial-verification convergence-loop code-review quality-gate
category: testing-quality
---
