...
description: >-
  Verification loop for Quarkus projects: build, static analysis, tests with coverage, security
  scans, native compilation, and diff review before release or PR.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: testing-quality
  tags: quarkus verification static-analysis code-coverage native-compilation
category: testing-quality
---
