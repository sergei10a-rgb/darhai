...
name: product-lens
description: >-
  Use this skill to validate the "why" before building, run product diagnostics, and pressure-test
  product direction before the request becomes an implementation contract.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: business-strategy
  tags: product-management product-strategy validation diagnostics prioritization
category: business-strategy
---
