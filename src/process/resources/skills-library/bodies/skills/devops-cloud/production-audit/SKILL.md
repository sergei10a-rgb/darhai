...
description: >-
  Local-evidence production readiness audit for shipped apps, pre-launch reviews, post-merge checks,
...
metadata:
  ...
  tags: production-readiness audit reliability pre-launch deployment
category: devops-cloud
---
