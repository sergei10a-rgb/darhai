...
description: >-
  Practical home and homelab network planning for gateways, switches, access points, IP ranges, DHCP
  reservations, DNS, cabling, and common beginner mistakes.
metadata:
  origin: community
  author: darhai
  version: 1.0.0
  category: devops-cloud
  tags: homelab home-network networking dhcp dns
category: devops-cloud
---
