...
description: >-
  Diagnostics-only BGP troubleshooting patterns for neighbor state, route exchange, prefix policy,
  AS path inspection, and safe evidence collection.
metadata:
  origin: community
  author: darhai
  version: 1.0.0
  category: devops-cloud
  tags: bgp networking routing diagnostics troubleshooting
category: devops-cloud
---
