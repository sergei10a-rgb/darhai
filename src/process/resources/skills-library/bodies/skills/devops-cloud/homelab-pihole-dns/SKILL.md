...
description: >-
  Pi-hole installation, blocklist management, DNS-over-HTTPS setup, DHCP integration, local DNS
  records, and troubleshooting broken DNS resolution on a home network.
metadata:
  origin: community
  author: darhai
  version: 1.0.0
  category: devops-cloud
  tags: pi-hole dns ad-blocking homelab dns-over-https
category: devops-cloud
---
