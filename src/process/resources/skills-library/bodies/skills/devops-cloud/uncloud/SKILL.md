...
name: uncloud
description: >-
  Use when managing an Uncloud cluster — deploying services, configuring Caddy ingress, adding
  static proxy routes for non-cluster devices, publishing ports, scaling, inspecting logs, or
  managing machines and volumes with the `uc` CLI.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: devops-cloud
  tags: uncloud cluster deployment caddy orchestration
category: devops-cloud
---
