...
description: >-
  Diagnose interface errors, drops, CRCs, duplex mismatches, flapping, speed negotiation issues, and
  counter trends on routers, switches, and Linux hosts.
metadata:
  origin: community
  author: darhai
  version: 1.0.0
  category: devops-cloud
  tags: network-interface diagnostics packet-loss duplex-mismatch health-check
category: devops-cloud
---
