...
description: >-
  ...
  operations, release management, and security monitoring using the gh CLI. Use when the user wants
  to manage GitHub issues, PRs, CI status, releases, contributors, stale items, or any GitHub
  operational task beyond simple git commands.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: devops-cloud
  tags: github ci-cd pull-requests release-management gh-cli
category: devops-cloud
---
