...
name: canary-watch
description: >-
  Use this skill to monitor and verify a deployed URL after releases — checks HTTP endpoints, SSE
  streams, static assets, console errors, and performance regressions after deploys, merges, or
  dependency upgrades. Smoke / canary / post-deploy verification.
metadata:
  origin: ECC
  author: darhai
  version: 1.0.0
  category: devops-cloud
  tags: canary monitoring smoke-test post-deploy verification
category: devops-cloud
---
