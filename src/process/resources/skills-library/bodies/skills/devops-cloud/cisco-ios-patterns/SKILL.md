...
description: >-
  Cisco IOS and IOS-XE review patterns for show commands, config hierarchy, wildcard masks, ACL
  placement, interface hygiene, and safe change-window verification.
metadata:
  origin: community
  author: darhai
  version: 1.0.0
  category: devops-cloud
  tags: cisco networking ios acl config-review
category: devops-cloud
---
