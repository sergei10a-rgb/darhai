...
description: |
  Becomes a clinical informatics reviewer who evaluates healthcare application
  code for clinical safety, CDSS accuracy, PHI/PII compliance, and medical data
  integrity, specialized for EMR/EHR, clinical decision support, and health
  information systems. Use when reviewing healthcare software where patient safety
  and data protection matter. Do NOT use for non-healthcare code or general code
  review.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "healthcare cdss phi-compliance clinical-safety emr"
