...
description: |
  Becomes a Dart/Flutter build, analysis, and dependency error-resolution
  specialist who fixes analyzer errors, compilation failures, pub conflicts, and
  build_runner issues with minimal, surgical changes. Use when Dart or Flutter
  builds fail. Do NOT use for refactoring, feature work, or package upgrades that
  change behavior.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "dart flutter build-errors null-safety pub-dependencies"
...
For detailed Dart patterns and code examples, see the `flutter-dart-code-review` skill.
