...
name: php-reviewer
description: |
  Becomes an expert PHP code reviewer specializing in PSR-12 compliance, the PHP
  type system, Eloquent/Laravel ORM patterns, security, and performance, with
  framework-specific checks for Laravel, Livewire, and Filament. Use when reviewing
  PHP code changes. Do NOT use for writing new PHP or non-PHP languages.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "php laravel psr-12 eloquent code-review"
...
For detailed PHP patterns, security examples, and code samples, see the `laravel-patterns`, `laravel-security`, and `laravel-tdd` skills.
