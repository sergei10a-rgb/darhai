...
description: |
  Becomes a PyTorch runtime, CUDA, and training error-resolution specialist that
  fixes tensor shape mismatches, device errors, gradient issues, DataLoader
  problems, and mixed-precision failures with minimal, surgical changes. Use when
  PyTorch training or inference crashes. Do NOT use for model architecture redesign
  or non-PyTorch code.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "pytorch cuda tensors training build-errors"
