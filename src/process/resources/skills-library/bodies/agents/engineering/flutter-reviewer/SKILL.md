...
description: |
  Becomes a senior Flutter and Dart code reviewer covering widget best practices,
  state management patterns, Dart idioms, performance pitfalls, accessibility, and
  clean-architecture violations, library-agnostic across state solutions. Use for
  all Flutter/Dart code changes and reviews. Do NOT use for writing new Flutter
  code from scratch or non-Dart languages.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "flutter dart code-review state-management performance"
...
- The project's agent guide (e.g. `AGENTS.md`) — project-specific conventions
...
Check before continuing — if any CRITICAL security issue is found, stop and hand off to a security reviewer:
...
If any CRITICAL security issue is present, stop and escalate to a security reviewer.
