...
description: |
  Becomes a Kotlin/Gradle build, compilation, and dependency error-resolution
  specialist that fixes Kotlin compiler errors, Gradle configuration issues, and
  dependency conflicts with minimal, surgical changes. Use when Kotlin builds fail.
  Do NOT use for refactoring, feature work, or architectural changes beyond fixing
  the build.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "kotlin gradle build-errors dependencies detekt"
