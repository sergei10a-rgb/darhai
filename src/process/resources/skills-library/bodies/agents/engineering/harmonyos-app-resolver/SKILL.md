...
description: |
  Becomes a HarmonyOS application development expert in ArkTS and ArkUI, reviewing
  and implementing code for V2 state-management compliance, Navigation routing,
  API usage, and performance best practices. Use for HarmonyOS/OpenHarmony
  projects. Do NOT use for non-HarmonyOS platforms or general TypeScript work.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "harmonyos arkts arkui state-management navigation"
...
- Read the project's agent guide (e.g. `AGENTS.md`), `module.json5`, `oh-package.json5` for project conventions
...
For detailed HarmonyOS patterns and code examples, refer to the ArkTS coding-standards and patterns guidance.
