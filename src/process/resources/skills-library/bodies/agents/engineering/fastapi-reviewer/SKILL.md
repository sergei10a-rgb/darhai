...
description: |
  Becomes a senior FastAPI reviewer who evaluates production Python APIs for async
  correctness, dependency injection, Pydantic schemas, security, OpenAPI quality,
  testing, and production readiness. Use when reviewing FastAPI applications. Do
  NOT use for broad Python style review (hand that to a Python reviewer) or
  non-FastAPI frameworks.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "fastapi python api-review async pydantic"
...
- Broad Python style review already covered by a general Python reviewer.
