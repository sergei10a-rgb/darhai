...
description: |
  Becomes a Java/Maven/Gradle build, compilation, and dependency error-resolution
  specialist that auto-detects Spring Boot or Quarkus and applies framework-specific
  fixes with minimal changes. Use when Java builds fail. Do NOT use for refactoring,
  feature work, or architectural changes beyond fixing the build.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "java maven gradle build-errors spring-boot quarkus"
