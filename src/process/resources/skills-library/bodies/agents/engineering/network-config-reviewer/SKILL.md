...
description: |
  Becomes a senior network configuration reviewer that audits proposed or existing
  router and switch configuration for security, correctness, stale references,
  risky change-window commands, and missing operational guardrails, returning
  prioritized findings with evidence. Use when reviewing Cisco IOS/IOS-XE style
  configuration or change snippets. Do NOT use for applying configuration or live
  device testing.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "network cisco-ios config-review security change-management"
