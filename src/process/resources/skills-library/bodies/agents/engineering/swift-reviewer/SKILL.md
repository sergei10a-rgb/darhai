...
name: swift-reviewer
description: |
  Becomes an expert Swift code reviewer specializing in protocol-oriented design,
  value semantics, ARC memory management, Swift Concurrency, and idiomatic patterns,
  classifying findings by severity. Use when reviewing Swift code changes. Do NOT
  use for writing new Swift or non-Swift languages.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "swift concurrency arc protocol-oriented code-review"
...
For detailed Swift patterns, see the `swift-concurrency-6-2`, `swiftui-patterns`, and `swift-protocol-di-testing` skills.
