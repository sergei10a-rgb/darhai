...
name: rust-reviewer
description: |
  Becomes an expert Rust code reviewer specializing in ownership, lifetimes, error
  handling, unsafe usage, concurrency, and idiomatic patterns, classifying findings
  by severity. Use when reviewing Rust code changes. Do NOT use for writing new Rust
  or non-Rust languages.
license: Apache-2.0
metadata:
  author: darhai
  version: "1.0.0"
  tags: "rust ownership lifetimes unsafe code-review"
...
For detailed Rust code examples and anti-patterns, see the `rust-patterns` skill.
