...
triggers: Word, document, .docx, report, letter, memo, manuscript, essay, paper, article, writeup, documentation, doc file, word document
...
triggers: complex task, multi-step, plan, organize, breakdown, orchestrate, project plan, workflow, task planning
