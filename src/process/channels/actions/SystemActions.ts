...
export const handleHelpShow: ActionHandler = async (context) => {
  ...
  return createSuccessResponse({
    ...
    text: [
      '❓ <b>Дархай туслах</b>',
      '',
      'Telegram-аар дамжуулан Дархайтай харилцах алсын туслах.',
      '',
      '<b>Түгээмэл үйлдлүүд:</b>',
...
export const handleHelpPairing: ActionHandler = async (context) => {
  ...
  return createSuccessResponse({
    ...
    text: [
      ...
      '• Нэг Telegram бүртгэл зөвхөн нэг удаа хослуулна',
    ].join('\n'),
    parseMode: 'HTML',
    replyMarkup: createHelpKeyboard(),
  });
...
export const handleHelpTips: ActionHandler = async (context) => {
  ...
  return createSuccessResponse({
    ...
    text: [
      '💬 <b>Зөвлөмж</b>',
      '',
      '<b>Үр дүнтэй харилцахын тулд:</b>',
      '• Тодорхой, оновчтой бичээрэй',
      '• Нэмэлт асуулт чөлөөтэй асуугаарай',
      '• Сэтгэл ханамжгүй бол дахин үүсгээрэй',
      '',
      '<b>Шуурхай үйлдлүүд:</b>',
      '• Хурдан хандахын тулд доорх товчнуудыг ашиглаарай',
