...
// Canonical base URL per provider - moved to `../chatStartHosts` so the legacy
// `model.config` mirror can share the same table without an import cycle
// (this module imports the mirror). Re-exported for `providerHosts.test.ts`
// and every other existing importer.
export { CHAT_START_BASE_URL };
