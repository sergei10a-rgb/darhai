...
2. Input line 1 is exactly `[DARHAI_CRON_FIRE:marketing-agency]` → weekly check-in.
...
Scan the list for any cron whose `message` line 1 is `[DARHAI_CRON_FIRE:marketing-agency]`. If found, skip - Company already standing. Otherwise proceed.
...
message: [DARHAI_CRON_FIRE:marketing-agency]
